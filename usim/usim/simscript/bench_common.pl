...
$SUITES{'msc'}      = 
'input/hmc.cfg input/PARSEC/black input/PARSEC/black input/PARSEC/black input/PARSEC/black
input/hmc.cfg input/PARSEC/face input/PARSEC/face input/PARSEC/face input/PARSEC/face
input/hmc.cfg input/PARSEC/ferret input/PARSEC/ferret input/PARSEC/ferret input/PARSEC/ferret
input/hmc.cfg input/PARSEC/fluid input/PARSEC/fluid input/PARSEC/fluid input/PARSEC/fluid
input/hmc.cfg input/PARSEC/freq input/PARSEC/freq input/PARSEC/freq input/PARSEC/freq
input/hmc.cfg input/PARSEC/stream input/PARSEC/stream input/PARSEC/stream input/PARSEC/stream
input/hmc.cfg input/PARSEC/swapt input/PARSEC/swapt input/PARSEC/swapt input/PARSEC/swapt
input/hmc.cfg input/PARSEC/MT0-canneal input/PARSEC/MT1-canneal input/PARSEC/MT2-canneal input/PARSEC/MT3-canneal
input/hmc.cfg input/PARSEC/MT0-fluid input/PARSEC/MT1-fluid input/PARSEC/MT2-fluid input/PARSEC/MT3-fluid
input/hmc.cfg input/BIOBENCH/mummer input/BIOBENCH/mummer input/BIOBENCH/mummer input/BIOBENCH/mummer
input/hmc.cfg input/BIOBENCH/tigr input/BIOBENCH/tigr input/BIOBENCH/tigr input/BIOBENCH/tigr
input/hmc.cfg input/COMMINTEL/comm1 input/COMMINTEL/comm1 input/COMMINTEL/comm1 input/COMMINTEL/comm1
input/hmc.cfg input/COMMINTEL/comm2 input/COMMINTEL/comm2 input/COMMINTEL/comm2 input/COMMINTEL/comm2
input/hmc.cfg input/COMMINTEL/comm3 input/COMMINTEL/comm3 input/COMMINTEL/comm3 input/COMMINTEL/comm3
input/hmc.cfg input/COMMINTEL/comm4 input/COMMINTEL/comm4 input/COMMINTEL/comm4 input/COMMINTEL/comm4
input/hmc.cfg input/COMMINTEL/comm5 input/COMMINTEL/comm5 input/COMMINTEL/comm5 input/COMMINTEL/comm5';
